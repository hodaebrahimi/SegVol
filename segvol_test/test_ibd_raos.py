...
### SET PARAMS HERE ###
imagesTr_root  = '/uhome/hoda2/rdss/p60290_1/IBD_Data/Dataset002_IBD/imagesTr'
labelsTr_root  = '/uhome/hoda2/rdss/p60290_1/IBD_Data/Dataset002_IBD/labelsTr_GT_bin'
save_data_root = './segvol_test/IBD_Predict'
...
IMAGE_PATTERN = re.compile(r'^IBD_(\d+)_0000\.nii\.gz$')
...
class IBDDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label_path = join(self.labels_root, f'IBD_{case_num}.nii.gz')
        ...
        if os.path.exists(label_path):
            ...
            data_item['label'] = np.array([])  # empty array instead of None
...
for item in tqdm(test_loader):
    ...
    case_save_dir = join(save_data_root, f'IBD_{case_num}')
    ...
    merged_save_path = join(case_save_dir, f'IBD_{case_num}_pred_binary.nii.gz')
